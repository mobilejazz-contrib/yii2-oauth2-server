...
class SocialAuthForm extends Model
{
    ...
    public function rules()
    {
        return [
            ...
            ['google_token', 'required', 'when' => function($model){
                return $model->provider === 'google';
            }],
            [['provider', 'facebook_token', 'google_token'], 'safe'],
            [['provider', 'facebook_token', 'google_token'], 'trim'],
            [['provider', 'client_id', 'client_secret'], 'string', 'max' => 32],
            [['facebook_token', 'google_token'], 'string', 'max' => 256],
